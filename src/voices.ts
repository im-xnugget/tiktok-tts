import type { TVoice, VoiceLanguage } from './types/internal';
...
export const languages = Object.keys(voices) as VoiceLanguage[];
...
export const voice = Object.keys(voiceNames) as TVoice[];
export const voiceIds = Object.values(voiceNames);
